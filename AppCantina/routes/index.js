...
router.get('/home', auth.verifyAuthNotAdmin, getListMealsandReserves,function(req, res, next) {
  res.render('home', { title: 'Home',currentDay:moment().add(req.week,'week'),startOfWeek:req.startOfWeek, endOfWeek:req.endOfWeek,user:req.user,meals:req.listMeals, user:req.user, reserves:req.reserves});
});
